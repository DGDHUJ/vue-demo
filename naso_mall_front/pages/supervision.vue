        ...
        <div class="__main layout">
          ...
          <div>
            <div class="grid-content bg-purple">
              ...
              <div class="title1">
                <p>Supervision of loading report</p>
              </div>
              <div class="title2">
                <img class="title2-img" src="../assets/img/supervision_title2.png" height="16" width="18"/>
                <p class="title2-content">Download Supervision of loading report</p>
              </div>
              ...
              <div class="title3">
                <p>Supervision of loading photos</p>
              </div>
              <div class="photos">
                 <el-row :gutter="20">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      getdata(){
         let that = this;
         let dataUrl = that.$store.state.headerUrl + 'member/order/'+that.tempid +'/report/0';
