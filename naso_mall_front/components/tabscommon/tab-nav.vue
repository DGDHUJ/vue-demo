<script>
  ...
  import { addResizeListener, removeResizeListener } from './js/resize-event';
  ...
  export default {
    ...
    methods: {
      ...
      scrollToActiveTab() {
        ...
        // console.log('activeTabBounding.left:' + activeTabBounding.left);
        // console.log('navScrollBounding.left:' + navScrollBounding.left);
        // console.log('activeTabBounding.right:' + activeTabBounding.right);
        // console.log('navScrollBounding.right:' + navScrollBounding.right);
        // console.log('navBounding.right:' + navBounding.right);
        // console.log('currentOffset:' + currentOffset);
        // console.log('navOffset' + this.navOffset);

        if (activeTabBounding.left < navScrollBounding.left) {
          newOffset = currentOffset - (navScrollBounding.left - activeTabBounding.left) - 90 ;
        }
        
        if (activeTabBounding.right > navScrollBounding.right) {
          newOffset = currentOffset + activeTabBounding.right - navScrollBounding.right + 90;
        }
        if (navBounding.right < navScrollBounding.right) {
          newOffset = nav.offsetWidth - navScrollBounding.width - 180;
        }
